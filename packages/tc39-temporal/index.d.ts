export class Absolute {
  ...
  inTimeZone(timezone?: TimeZone): DateTime;
}
...
export class DateTime implements DateTimeLike {
  ...
  inTimeZone(timeZone?: TimeZone, disambiguation?: 'constrain' | 'balance' | 'reject'): any; // TODO
  getDate(): Date;
  getYearMonth(): any; // TODO
  getMonthDay(): any; // TODO
  getTime(): Time;
...
export type TimeZone = never; // TODO

// now

export namespace now {
  export function absolute(): Absolute;
  export function dateTime(zone?: TimeZone): DateTime;
  export function date(zone?: TimeZone): Date;
  export function time(zone?: TimeZone): Time;
